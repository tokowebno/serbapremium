...
const productSpecs: RawAppSpec[] = [
  ...
  // ── 1. AI & Chatbot ───────────────────────────────────────────
  {
    ...
    glyph: "bot",
    colorKey: "chatgpt",
    tagline: "Akses Model AI Terbaru, Reasoning, Canvas & DALL-E (Full Garansi)",
    description: "Langganan resmi ChatGPT Plus Apple Pay dengan akses prioritas ke model penalaran dan bahasa terbaru dari OpenAI. Dilengkapi full garansi penggantian selama masa aktif. Mendukung pembuatan gambar, analisis data Python, browsing web realtime, dan fitur Canvas interaktif.",
    platforms: ["Web", "Android", "iOS", "macOS", "Windows"],
    features: [
      "Akses model OpenAI terbaru tanpa antrean (Full Garansi)",
      "Batas kuota chat 5x lebih tinggi dibanding akun gratis",
      "Fitur Canvas, Analisis Data Terpadu & Custom GPTs",
      "Garansi penggantian akun penuh 100% selama masa aktif",
    ],
    variants: [
      {
        id: "chatgpt-plus-1m",
        name: "ChatGPT Plus Apple Pay 1Month",
        duration: "1 Bulan",
        accessType: "Plus Apple Pay",
        price: 40000,
        originalPrice: 60000,
        stock: 151,
        badge: "Paling Laris",
  ...
  },
  {
    ...
    glyph: "sparkles",
    colorKey: "gemini",
    tagline: "Model Google AI Premium Terbaru & Cloud Storage (Full Garansi)",
    description: "Akses Google AI Premium (Gemini Advanced) didukung model generasi terbaru dengan pemahaman konteks maksimal, integrasi Google Workspace (Docs, Gmail), generator gambar, dan fitur Deep Research. Dilengkapi full garansi masa aktif.",
    platforms: ["Web", "Android", "iOS"],
    features: [
      "Akses Gemini Advanced dengan model generasi terbaru (Full Garansi)",
