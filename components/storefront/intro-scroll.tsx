...
export function IntroScroll() {
  ...
  // ── Selesai saat scroll nyaris habis ─────────────────────────
  useEffect(() => {
    if (reduce) {
      setPhase("done");
      return;
  ...
  return (
    <>
      {/* Ruang gulir intro — sumber "putaran video" */}
      {phase === "intro" && <div ref={spacerRef} className="h-[340vh]" aria-hidden="true" />}
